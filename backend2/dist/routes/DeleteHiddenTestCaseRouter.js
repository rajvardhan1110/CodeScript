...
exports.DeleteHiddenTestCaseHandler = void 0;
const express_1 = __importDefault(require("express"));
const mongoose_1 = __importDefault(require("mongoose"));
const AdminAuthMiddleware_1 = require("../Middleware/AdminAuthMiddleware");
const ProblemModel_1 = require("../models/ProblemModel");
const DeleteHiddenTestCaseRouter = express_1.default.Router();
const DeleteHiddenTestCaseHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        problem.hiddenTestCases = problem.hiddenTestCases.filter((tc) => !tc._id.equals(new mongoose_1.default.Types.ObjectId(testCaseId)));
...
exports.DeleteHiddenTestCaseHandler = DeleteHiddenTestCaseHandler;
DeleteHiddenTestCaseRouter.delete("/", AdminAuthMiddleware_1.AdminAuthMiddleware, exports.DeleteHiddenTestCaseHandler);
exports.default = DeleteHiddenTestCaseRouter;
